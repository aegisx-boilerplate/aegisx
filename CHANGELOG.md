...
* fix(release): correct semantic-release configuration and version ([ee08dfd](https://github.com/aegisx-boilerplate/aegisx/commit/ee08dfd))
...
* fix(version): revert to version 2.5.0 from incorrect v3.x.x bump ([05c5501](https://github.com/aegisx-boilerplate/aegisx/commit/05c5501))
* chore(release): 3.0.0 [skip ci] ([a8103dc](https://github.com/aegisx-boilerplate/aegisx/commit/a8103dc))
* chore(release): 3.0.0 [skip ci] ([67f28f1](https://github.com/aegisx-boilerplate/aegisx/commit/67f28f1))
...
* refactor: cleanup unused files after audit system refactoring ([cf2152a](https://github.com/aegisx-boilerplate/aegisx/commit/cf2152a))
