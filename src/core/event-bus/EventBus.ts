...
export class EventBus {
  ...
  constructor(eventConfig: EventBusConfig = {}) {
    this.config = {
      exchange: eventConfig.exchange || config.eventBus.exchange,
      exchangeType: eventConfig.exchangeType || config.eventBus.exchangeType,
      durable: eventConfig.durable ?? config.eventBus.durable,
      ...eventConfig,
    };
  }
